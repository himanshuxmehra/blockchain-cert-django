# Generated by Django 3.1.2 on 2020-10-25 05:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Idle', 'Idle'), ('Processing', 'Processing'), ('Done', 'Done')], default='Idle', max_length=60, null=True)),
                ('result_csv', models.FileField(editable=False, upload_to='')),
